...
<body>
	<c:if test="${empty requestScope.books  }">
		<jsp:forward page="/IndexServlet?action=index"></jsp:forward>
	</c:if>
	<div id="wrap">
		<div class="header">
			<div class="logo">
		...
		<div class="center_content">
			<div class="left_content">
				...
				<c:forEach items="${requestScope.books }" var="book" begin="0"
					end="3">
					<div class="feat_prod_box">

						<div class="prod_img">
							<a href="${pageContext.request.contextPath}/BookServlet?action=findById&&id=${book.id}&&name=${book.name}"><img
								src="${pageContext.request.contextPath }/${book.img}"
								style="width: 100px; height: 140px" alt="" title="" border="0" /></a>
						</div>
						<div class="prod_det_box">
							...
							<div class="box_center">
								...
								<p class="details">
									<font color=red>分类:${book.typename }</font> &nbsp;&nbsp;
									star:${book.star }
								</p>
								<p class="details"
									style="display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden; height: 30px">
									<font color=red>描述:</font>${book.detail }</p>

								<a href="${pageContext.request.contextPath}/BookServlet?action=findById&&id=${book.id}" class="more">更多..</a>
								<div class="clear"></div>
							</div>
				...
				<div class="new_products">
					<c:forEach items="${requestScope.booknew }" var="book" begin="0"
					end="2">
					<div class="new_prod_box">
						...
						<div class="new_prod_bg">
							<span class="new_icon"><img src="images/new_icon.gif"
								...
								src="${pageContext.request.contextPath }/${book.img}" style="width:70px;height:90px"  alt="" title="" class="thumb" border="0" /></a>
						</div>
					</div>
					</c:forEach>
				</div>
