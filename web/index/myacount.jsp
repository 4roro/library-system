			...
			<div class="left_content">
				...
				<div class="feat_prod_box_details">
							<div class="contact_form">
								<div class="form_subtitle">登录您的账户</div>
								<form
									action="${pageContext.request.contextPath}/UserServlet?action=login"
									method="post">
									<div class="form_row">
									...
									<div class="form_row">
										...
										<a class="button border-main icon-plus-square-o" href="register.jsp"> 用户注册</a>
									</div>
								</form>
							</div>
				</div>
