...
<div id="wrap">
       ...
       <div class="header">
        ...
        <div id="menu">
            <ul>                                                                       
					...
					<li class="selected"><a href="${pageContext.request.contextPath}/NoticeServlet?action=findNotice">公告</a></li>
       ...
       <div class="center_content">
       	<div class="left_content">
            <div class="title"><span class="title_icon"><img src="images/bullet1.gif" alt="" title="" /></span>人事公告</div>
            ...
            <ul class="list">
						<c:forEach items="${requestScope.notice }" var="notice" >
							<li><font color=red size="+1">${notice.title }</font></a>&nbsp;&nbsp;<font color=red>发布日期:${notice.datetime }</font></li>
							<li>${notice.detail }</li>
						</c:forEach>
			</ul>
